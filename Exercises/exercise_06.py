...
class Scrape_Saver:
    ...
    def retrieve(self, item):
        ...
        # if(os.path.isfile(self.save_location+item+".txt")):
        #
        #  file = open(self.save_location, "w")
        # else:
        #  y = ur.urlopen(self.base_url).read()
        #  file = open(self.save_location+item+".txt", "w")
        #  file.write(y.decode())
        #  file.close()
        # # return
...
if __name__ == '__main__':
    ...
    x = Scrape_Saver(url, '/Users/rashmithareddy/Desktop/saves/')
