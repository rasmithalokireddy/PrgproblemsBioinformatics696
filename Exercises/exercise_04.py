...
def percent_decimal(numbers):
    ...
    x= [i/100 if i >1 else i*100 for i in numbers]

    print(x)

percent_decimal([0.0, 0.5, 1.0, 50.0, 100.0])
...
def multiple_proteins_from_rna(rna):
    ...
    protein_list= [protein[index:][:-1] for index, char in enumerate(protein) if char == "M"]


    print(protein_list)

multiple_proteins_from_rna("UCCAUGUUUAUGAGGAGGUGA")